...
export const FeedbackRow = React.memo(({ project, rating, feedback }) => {
    return (
    ...
    return prevProps.project.id === nextProps.project.id && prevProps.rating === nextProps.rating && prevProps.feedback === nextProps.feedback;
});