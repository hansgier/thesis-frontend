    ...
    return (
        <>
            ...
            <div className="fixed flex flex-col h-full items-center justify-center w-full">
                <img src="404%20Page%20Not%20Found%201.svg" className="bg-cover w-60" loading="lazy" />
                ...
                <button
                    onClick={ () => navigate(-1) }
                    className="border-2 border-Thesis-200 hover:bg-blue-50 px-4 py-3 rounded-md text-sm md:text-base"
                    type="button">Go back
                </button>
            </div>
        </>
