            ...
            <div className="gap-6 grid grid-cols-1 min-h-[calc(100vh_-_theme(spacing.16))] md:gap-4">
                                ...
                                <div
                                    ...
                                    <div className="gap-1 grid h-full ml-2 md:ml-0">
                                        ...
                                        <p className="mx-2 select-none text-gray-600 text-xs md:text-gray-600 md:text-sm">
                                            A project to create a beautiful community garden for everyone to enjoy. </p>
                                    </div>
                                    <a href=""
                                ...
                                <li className="p-4">
                                    <div
                                        ...
                                        <div className="grid gap-1">
                                            <p className="font-semibold text-sm whitespace-normal md:text-base">Music in
                                                the
                                                Park</p>
                                            <p className="text-gray-600 text-xs truncate md:text-sm">Enjoy live music in
                                                our
                                                beautiful park. Date: July 15thEnjoy live music in our beautiful park.
                                                Date: July 15thEnjoy live music in our beautiful park. Date: July
                                                15thEnjoy live music in our beautiful park. Date: July 15thEnjoy live
                                ...
                                <li className="p-4">
                                    <div
                                        ...
                                        <img
                                            ...
                                            width="80" height="80"
                                            className="rounded-lg w-10 md:w-20 aspect-[80/80] object-cover" alt="Event"
                                        />
                                        <div className="grid gap-1">
                ...
                <div className="md:mx-0 mx-4 rounded-xl" data-v0-t="card">
                    <div className="flex-col gap-1 grid pr-6 py-6 select-none space-y-1.5">
                        ...
                        <p className="font-normal text-gray-600 text-xs md:text-sm">Stay informed with these important
                            updates.</p>
                    </div>
                                ...
                                <div
                                    ...
                                    <div className="grid gap-1">
                                        ...
                                        <p className="text-gray-600 text-xs truncate md:max-w-xl md:text-sm">We&apos;re
                                            ...
                                            construction from
                                            July 10th.We&apos;re building a new playground in the park. The playground
                                            will be closed for construction from July 10th.We&apos;re building a new
                                            playground in the park. The playground will be closed for construction from
                                            July 10th.</p>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div
                                    ...
                                    <div className="grid gap-1">
                                        ...
                                        <p className="text-gray-600 text-xs truncate md:max-w-xl md:text-sm">
                                            Part of Main Street will be closed for repairs from July 15th to July 20th.
                                ...
                                <div
                                    ...
                                    <div className="grid gap-1">
                                        <p className="font-semibold text-sm whitespace-normal md:text-base">Community
                                            Picnic</p>
                                        <p className="text-gray-600 text-xs truncate md:max-w-xl md:text-sm">
                                            Join us for a fun community picnic on July 30th. There will be games, food,
                                            and music. </p>
                                    </div>
                                </div>
                            </li>
                ...
                <div className="mb-4 md:mx-0 mx-4 rounded-xl" data-v0-t="card">
                    <div className="flex-col gap-1 grid pr-6 py-6 select-none space-y-1.5">
                        <h3 className="font-bold leading-none text-xl tracking-tight whitespace-normal md:text-2xl">Feedback
                            Summary</h3>
                        <p className="font-normal text-gray-600 text-xs md:text-sm">See what the community thinks about
                            recent projects.</p>
                    </div>
                    <div>
                                ...
                                <div className="bg-white border-2 border-[#daf4aa] rounded-xl" data-v0-t="card">
                                    <div className="p-6 space-y-4">
                                        ...
                                        <p className="select-none text-gray-600 text-sm md:text-base">
                                            The feedback for Project A has been very positive, with users appreciating
