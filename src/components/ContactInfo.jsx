...
export const ContactInfo = ({ logo, name, address, emails, phones }) => {
    return (
        <div
            className="bg-white border-2 hover:duration-300 hover:shadow-lg hover:transition-shadow mx-4 p-5 rounded-xl space-y-2 md:mx-0"
        >
            ...
            { address === "" || (
                <div className="flex group pl-3 space-x-4 md:pl-2">
                    <div>
                        <GrLocation className="h-5 md:w-5 md:h-5" color={ "#5c5c5c" } />
                    </div>
            ...
            { emails.map((email, index) => (
                <div key={ index } className="flex group pl-3 space-x-4 md:pl-2">
                    <div>
                        <HiOutlineMail className="h-5 md:w-5 md:h-5" color={ "#5c5c5c" } />
                    </div>
            ...
            { phones.map((phone, index) => (
                <div key={ index } className="flex group pl-3 space-x-4 md:pl-2">
                    <div>
                        <LuPhone className="h-5 md:w-5 md:h-5" color={ "#5c5c5c" } />
                    </div>
