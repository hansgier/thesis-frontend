export const FilterSort = () => {
    return (
        <div className="border-b-2 mb-6 overflow-hidden pt-0 px-6 relative md:pt-3">
            <div className="flex flex-row gap-2 justify-between mt-1 lg:flex-row">
                <div className="flex items-center">
                    ...
                    <button
                        className="border disabled:opacity-50 focus:border-Thesis-200 focus:outline-none font-medium h-9 hover:bg-blue-50 hover:text-gray-700 inline-flex items-center justify-center px-4 py-2 rounded-full text-gray-500 text-xs transition-colors whitespace-nowrap md:text-sm">
            ...
            <div className="mb-6 mt-5 px-2">
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <select defaultValue="none"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                             className="h-4 w-4 opacity-50" aria-hidden="true">
