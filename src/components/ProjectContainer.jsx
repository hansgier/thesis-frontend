export const ProjectContainer = () => {
    return (
        <a>
            <div
                className="accent-indigo-800 bg-white border-2 hover:cursor-pointer hover:duration-500 hover:ease-out hover:shadow-gray-300 hover:shadow-xl hover:transition-shadow mb-10 mx-3 rounded-xl md:mx-0"
                data-v0-t="card">
                <div className="flex gap-4 items-center pb-4 pt-6 px-4 md:px-6">
                        ...
                        <div className="flex items-center">
                            <div className="flex group items-center mr-4 space-x-1">
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="14">
                                    ...
                                    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier">
                                        <path d="M12 8V12L15 15" stroke="rgba(156,163,175,1)" strokeWidth="2"
                                              strokeLinecap="round"></path>
                                        <circle cx="12" cy="12" r="9" stroke="rgba(156,163,175,1)"
                                                strokeWidth="2"></circle>
                                    </g>
                                </svg>
                                <p className="group-hover:underline mr-5 select-none text-gray-400 text-xs">2d ago</p>
                            </div>
                    ...
                    <div className="flex items-center ml-auto space-x-2 text-gray-500 text-xs">
                        <div
                            className="hover:bg-blue-50 hover:duration-300 hover:rounded-lg hover:transition-all p-1 lg:hidden">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="20">
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    ...
                                    <path d="M12 17V11" stroke="#1C274C" strokeWidth="1.5"
                                          strokeLinecap="round"></path>
                        ...
                        <span className="hidden select-none lg:block">City Government</span>
                    </div>
                </div>
                <div className="mb-4 px-4 md:px-6">
                    <p className="leading-relaxed md:text-base select-none text-gray-700 text-justify text-sm">The
                        Valley Road Expansion project will widen the existing two-lane road to four lanes over a 5-mile
                        stretch between Main Street and Interstate 95. Intersection improvements with turn lanes,
                        roundabouts, and traffic signals will be added. Drainage, curbs, sidewalks, and paved shoulders
                        will also be constructed. The $22 million project is funded by state and federal grants, with
                        construction from 2025 to 2027. Once complete, Valley Road will have increased capacity and
                ...
                <div className="gap-2 grid pb-3 px-4 md:px-6">
                    <div className="flex gap-2 h-8 items-center mt-4 text-sm md:gap-4">
                        <div className="flex gap-1 h-full">
                            ...
                            <span
                                className="dark:text-gray-400 flex h-auto items-center select-none text-gray-500 text-xs md:text-sm">23</span>
                        </div>
                        <div className="flex gap-1 h-full items-center justify-center">
                            ...
                            <span
                                className="dark:text-gray-400 flex h-full items-center justify-center select-none text-gray-500 text-xs md:text-sm">9</span>
                        </div>
                        <div
                            ...
                            <span className="dark:text-gray-400 select-none text-gray-500 text-xs md:text-sm">12 comments</span>
                        </div>
                        <div className="flex gap-1 h-full items-center">
                            ...
                            <span className="dark:text-gray-400 select-none text-gray-500 text-xs md:text-sm">23</span>
                        </div>
                    </div>
                </div>
            </div>
