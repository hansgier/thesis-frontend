                ...
                <div
                    ...
                    { user.role === "guest" ? (
                        ...
                        <Popover trigger="click"
                                 content={ <LogViewProfilePopup mode="mobile" /> }
                                 className="w-full flex items-center m-0 p-0"
                                 arrow={ false }
                                 placement="topLeft"
                        >
                            <div onClick={ togglePopup } className="space-x-2 group">
                                <div
                                ...
                                <div
                                    ...
                                    <svg fill="#6b7280" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                         className="w-4 group-hover:fill-rose-600">
                                        <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
